var organizationField = '<input type="text" class="u2g-form-group__field" name="organization" data-rule-required="true">';
var idNumber = $('.js-id-number');
var nonGeorgian = $('.js-non-georgian');
